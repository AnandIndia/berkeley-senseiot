...
const EMBEDDED_ASSETS = {
  ...
  '/styles.css': "/* ==========================================================================\n   BERKELEY SENSEIOT - STYLESHEET\n   Brand Theme: Berkeley (Blue #2B388F, Green #00843D, Orange #F4981C, Red #C01E2E)\n   \"DEFINED BY TRUST\"\n   ========================================================================== */\n\n:root {\n  --bky-blue: #2B388F;\n  --bky-blue-hover: #222C74;\n  --bky-blue-light: #EEF2FF;\n  --bky-green: #00843D;\n  --bky-green-light: #ECFDF5;\n  --bky-orange: #F4981C;\n  --bky-orange-light: #FFFBEB;\n  --bky-red: #C01E2E;\n  --bky-red-light: #FEF2F2;\n  --bky-indigo: #4F46E5;\n\n  /* Theme: Dark Industrial Default */\n  --bg-app: #0B0F19;\n  --bg-sidebar: #0E1424;\n  --bg-card: #151D30;\n  --bg-card-hover: #1A243B;\n  --bg-input: #0F1626;\n  --border-color: #232F48;\n  --border-focus: #3B82F6;\n  --text-primary: #F8FAFC;\n  --text-secondary: #94A3B8;\n  --text-muted: #64748B;\n  --shadow-sm: 0 1px 2px 0 rgba(0, 0, 0, 0.4);\n  --shadow-md: 0 4px 12px -2px rgba(0, 0, 0, 0.5);\n  --shadow-lg: 0 10px 25px -3px rgba(0, 0, 0, 0.6);\n  --radius-sm: 6px;\n  --radius-md: 10px;\n  --radius-lg: 16px;\n}\n\n[data-theme=\"light\"] {\n  --bg-app: #F4F6FB;\n  --bg-sidebar: #FFFFFF;\n  --bg-card: #FFFFFF;\n  --bg-card-hover: #F8FAFC;\n  --bg-input: #F1F5F9;\n  --border-color: #E2E8F0;\n  --border-focus: #2B388F;\n  --text-primary: #0F172A;\n  --text-secondary: #475569;\n  --text-muted: #94A3B8;\n  --shadow-sm: 0 1px 3px 0 rgba(0, 0, 0, 0.08);\n  --shadow-md: 0 4px 12px -2px rgba(0, 0, 0, 0.1);\n  --shadow-lg: 0 10px 25px -3px rgba(0, 0, 0, 0.12);\n}\n\n* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Oxygen, Ubuntu, Cantarell, \"Helvetica Neue\", sans-serif;\n}\n\nbody {\n  background-color: var(--bg-app);\n  color: var(--text-primary);\n  min-height: 100vh;\n  display: flex;\n  overflow-x: hidden;\n  transition: background-color 0.2s ease, color 0.2s ease;\n}\n\n/* --- Layout Grid --- */\n.app-container {\n  display: flex;\n  width: 100vw;\n  min-height: 100vh;\n}\n\n/* --- Sidebar Navigation --- */\n.sidebar {\n  width: 260px;\n  background-color: var(--bg-sidebar);\n  border-right: 1px solid var(--border-color);\n  display: flex;\n  flex-direction: column;\n  flex-shrink: 0;\n  z-index: 40;\n  transition: width 0.2s ease, transform 0.2s ease;\n}\n\n.brand-header {\n  padding: 20px 18px 16px;\n  border-bottom: 1px solid var(--border-color);\n  display: flex;\n  align-items: center;\n  gap: 12px;\n}\n\n.brand-logo-img {\n  height: 38px;\n  object-fit: contain;\n}\n\n.brand-text {\n  display: flex;\n  flex-direction: column;\n}\n\n.brand-title {\n  font-size: 1.15rem;\n  font-weight: 800;\n  letter-spacing: -0.5px;\n  color: var(--text-primary);\n  display: flex;\n  align-items: center;\n  gap: 6px;\n}\n\n.brand-badge {\n  background: linear-gradient(135deg, var(--bky-blue), #3B82F6);\n  color: #fff;\n  font-size: 0.65rem;\n  padding: 2px 6px;\n  border-radius: 4px;\n  font-weight: 700;\n  text-transform: uppercase;\n  letter-spacing: 0.5px;\n}\n\n.brand-subtitle {\n  font-size: 0.65rem;\n  color: var(--text-muted);\n  font-weight: 600;\n  letter-spacing: 1px;\n  text-transform: uppercase;\n  margin-top: 2px;\n}\n\n/* Berkeley 4-Color Accent Stripe */\n.berkeley-stripe {\n  height: 4px;\n  width: 100%;\n  background: linear-gradient(to right, \n    var(--bky-blue) 0%, var(--bky-blue) 25%, \n    var(--bky-green) 25%, var(--bky-green) 50%, \n    var(--bky-orange) 50%, var(--bky-orange) 75%, \n    var(--bky-red) 75%, var(--bky-red) 100%\n  );\n}\n\n.sidebar-nav {\n  padding: 16px 12px;\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n  flex-grow: 1;\n}\n\n.nav-section-title {\n  font-size: 0.68rem;\n  font-weight: 700;\n  text-transform: uppercase;\n  letter-spacing: 1px;\n  color: var(--text-muted);\n  padding: 12px 10px 6px;\n}\n\n.nav-item {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  padding: 10px 14px;\n  border-radius: var(--radius-sm);\n  color: var(--text-secondary);\n  text-decoration: none;\n  font-size: 0.9rem;\n  font-weight: 500;\n  cursor: pointer;\n  border: 1px solid transparent;\n  transition: all 0.15s ease;\n}\n\n.nav-item:hover {\n  background-color: var(--bg-card-hover);\n  color: var(--text-primary);\n}\n\n.nav-item.active {\n  background-color: rgba(43, 56, 143, 0.18);\n  color: #60A5FA;\n  border-color: rgba(43, 56, 143, 0.4);\n  font-weight: 600;\n}\n\n[data-theme=\"light\"] .nav-item.active {\n  background-color: var(--bky-blue-light);\n  color: var(--bky-blue);\n  border-color: rgba(43, 56, 143, 0.2);\n}\n\n.nav-item svg {\n  width: 18px;\n  height: 18px;\n  flex-shrink: 0;\n}\n\n.nav-pill {\n  margin-left: auto;\n  font-size: 0.7rem;\n  font-weight: 700;\n  padding: 2px 7px;\n  border-radius: 999px;\n  background-color: rgba(244, 152, 28, 0.15);\n  color: var(--bky-orange);\n}\n\n.nav-pill.danger {\n  background-color: rgba(192, 30, 46, 0.2);\n  color: #F87171;\n}\n\n.sidebar-footer {\n  padding: 14px 16px;\n  border-top: 1px solid var(--border-color);\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n}\n\n.system-status-indicator {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  font-size: 0.75rem;\n  color: var(--text-secondary);\n}\n\n.status-dot {\n  width: 8px;\n  height: 8px;\n  border-radius: 50%;\n  background-color: var(--bky-green);\n  box-shadow: 0 0 8px var(--bky-green);\n  animation: pulse-dot 2s infinite;\n}\n\n@keyframes pulse-dot {\n  0% { transform: scale(0.95); opacity: 0.8; }\n  50% { transform: scale(1.15); opacity: 1; box-shadow: 0 0 12px var(--bky-green); }\n  100% { transform: scale(0.95); opacity: 0.8; }\n}\n\n/* --- Main Content Area --- */\n.main-wrapper {\n  flex-grow: 1;\n  display: flex;\n  flex-direction: column;\n  min-width: 0;\n  height: 100vh;\n  overflow-y: auto;\n}\n\n/* --- Top App Header --- */\n.top-header {\n  background-color: var(--bg-sidebar);\n  border-bottom: 1px solid var(--border-color);\n  padding: 12px 24px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  position: sticky;\n  top: 0;\n  z-index: 30;\n}\n\n.header-left {\n  display: flex;\n  align-items: center;\n  gap: 14px;\n}\n\n.view-title-wrap {\n  display: flex;\n  flex-direction: column;\n}\n\n.view-title {\n  font-size: 1.25rem;\n  font-weight: 700;\n  color: var(--text-primary);\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n\n.view-breadcrumbs {\n  font-size: 0.75rem;\n  color: var(--text-muted);\n}\n\n.header-right {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n}\n\n.top-btn {\n  display: inline-flex;\n  align-items: center;\n  gap: 6px;\n  padding: 7px 12px;\n  border-radius: var(--radius-sm);\n  font-size: 0.82rem;\n  font-weight: 600;\n  border: 1px solid var(--border-color);\n  background-color: var(--bg-card);\n  color: var(--text-primary);\n  cursor: pointer;\n  transition: all 0.15s ease;\n}\n\n.top-btn:hover {\n  background-color: var(--bg-card-hover);\n  border-color: var(--border-focus);\n}\n\n.top-btn.primary {\n  background-color: var(--bky-blue);\n  color: #FFFFFF;\n  border-color: var(--bky-blue);\n}\n\n.top-btn.primary:hover {\n  background-color: var(--bky-blue-hover);\n}\n\n.top-btn.danger {\n  background-color: rgba(192, 30, 46, 0.15);\n  color: #F87171;\n  border-color: rgba(192, 30, 46, 0.3);\n}\n\n.top-btn.danger:hover {\n  background-color: rgba(192, 30, 46, 0.25);\n}\n\n.top-btn.active-mobile {\n  background: linear-gradient(135deg, #4F46E5, #7C3AED);\n  color: #FFF;\n  border-color: #6366F1;\n}\n\n/* --- Fault Injection Bar --- */\n.fault-bar {\n  background-color: rgba(15, 23, 42, 0.9);\n  border-bottom: 1px solid rgba(244, 152, 28, 0.3);\n  padding: 8px 24px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  font-size: 0.8rem;\n  gap: 12px;\n  flex-wrap: wrap;\n}\n\n[data-theme=\"light\"] .fault-bar {\n  background-color: #FEF3C7;\n  border-bottom: 1px solid #FCD34D;\n  color: #92400E;\n}\n\n.fault-bar-title {\n  display: flex;\n  align-items: center;\n  gap: 6px;\n  font-weight: 700;\n  color: var(--bky-orange);\n}\n\n.fault-actions {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  flex-wrap: wrap;\n}\n\n.fault-pill-btn {\n  background-color: var(--bg-card);\n  border: 1px solid var(--border-color);\n  padding: 4px 10px;\n  border-radius: 999px;\n  font-size: 0.75rem;\n  font-weight: 600;\n  cursor: pointer;\n  color: var(--text-primary);\n  transition: all 0.15s ease;\n  display: inline-flex;\n  align-items: center;\n  gap: 5px;\n}\n\n.fault-pill-btn:hover {\n  background-color: rgba(192, 30, 46, 0.15);\n  border-color: var(--bky-red);\n  color: #F87171;\n}\n\n.fault-pill-btn.clear {\n  background-color: rgba(0, 132, 61, 0.15);\n  border-color: rgba(0, 132, 61, 0.4);\n  color: #34D399;\n}\n\n/* --- View Content Containers --- */\n.content-area {\n  padding: 24px;\n  flex-grow: 1;\n}\n\n.view-pane {\n  display: none;\n  animation: fadeIn 0.2s ease-in-out;\n}\n\n.view-pane.active {\n  display: block;\n}\n\n@keyframes fadeIn {\n  from { opacity: 0; transform: translateY(4px); }\n  to { opacity: 1; transform: translateY(0); }\n}\n\n/* --- KPI Stats Row --- */\n.stats-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(220px, 1fr));\n  gap: 16px;\n  margin-bottom: 24px;\n}\n\n.stat-card {\n  background-color: var(--bg-card);\n  border: 1px solid var(--border-color);\n  border-radius: var(--radius-md);\n  padding: 18px 20px;\n  position: relative;\n  overflow: hidden;\n  box-shadow: var(--shadow-sm);\n  transition: transform 0.15s ease, box-shadow 0.15s ease;\n}\n\n.stat-card:hover {\n  transform: translateY(-2px);\n  box-shadow: var(--shadow-md);\n}\n\n.stat-card-stripe {\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  height: 3px;\n}\n\n.stat-card-stripe.blue { background-color: var(--bky-blue); }\n.stat-card-stripe.green { background-color: var(--bky-green); }\n.stat-card-stripe.orange { background-color: var(--bky-orange); }\n.stat-card-stripe.red { background-color: var(--bky-red); }\n\n.stat-header {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-bottom: 10px;\n}\n\n.stat-label {\n  font-size: 0.8rem;\n  font-weight: 600;\n  color: var(--text-secondary);\n  text-transform: uppercase;\n  letter-spacing: 0.5px;\n}\n\n.stat-icon {\n  width: 32px;\n  height: 32px;\n  border-radius: var(--radius-sm);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background-color: rgba(43, 56, 143, 0.12);\n  color: #60A5FA;\n}\n\n.stat-value {\n  font-size: 1.75rem;\n  font-weight: 800;\n  color: var(--text-primary);\n  line-height: 1.2;\n}\n\n.stat-subtext {\n  font-size: 0.75rem;\n  color: var(--text-muted);\n  margin-top: 6px;\n  display: flex;\n  align-items: center;\n  gap: 6px;\n}\n\n/* --- Section Containers --- */\n.section-card {\n  background-color: var(--bg-card);\n  border: 1px solid var(--border-color);\n  border-radius: var(--radius-md);\n  box-shadow: var(--shadow-sm);\n  margin-bottom: 24px;\n  overflow: hidden;\n}\n\n.section-header {\n  padding: 16px 20px;\n  border-bottom: 1px solid var(--border-color);\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  gap: 12px;\n}\n\n.section-title {\n  font-size: 1rem;\n  font-weight: 700;\n  color: var(--text-primary);\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n\n.section-tools {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n}\n\n/* --- Asset Fleet Cards Grid --- */\n.asset-grid {\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(320px, 1fr));\n  gap: 18px;\n  padding: 20px;\n}\n\n.asset-card {\n  background-color: var(--bg-card);\n  border: 1px solid var(--border-color);\n  border-radius: var(--radius-md);\n  padding: 18px;\n  box-shadow: var(--shadow-sm);\n  transition: all 0.2s ease;\n  display: flex;\n  flex-direction: column;\n  position: relative;\n}\n\n.asset-card:hover {\n  border-color: rgba(59, 130, 246, 0.4);\n  box-shadow: var(--shadow-md);\n  transform: translateY(-2px);\n}\n\n.asset-card-top {\n  display: flex;\n  align-items: flex-start;\n  justify-content: space-between;\n  margin-bottom: 12px;\n}\n\n.asset-name {\n  font-size: 1rem;\n  font-weight: 700;\n  color: var(--text-primary);\n  margin-bottom: 4px;\n}\n\n.asset-meta {\n  font-size: 0.78rem;\n  color: var(--text-muted);\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n\n.status-badge {\n  display: inline-flex;\n  align-items: center;\n  gap: 5px;\n  padding: 3px 8px;\n  border-radius: 999px;\n  font-size: 0.72rem;\n  font-weight: 700;\n  text-transform: uppercase;\n  letter-spacing: 0.4px;\n}\n\n.status-badge.HEALTHY {\n  background-color: rgba(0, 132, 61, 0.15);\n  color: #34D399;\n  border: 1px solid rgba(0, 132, 61, 0.3);\n}\n\n.status-badge.WARNING {\n  background-color: rgba(244, 152, 28, 0.15);\n  color: #FBBF24;\n  border: 1px solid rgba(244, 152, 28, 0.3);\n}\n\n.status-badge.CRITICAL {\n  background-color: rgba(192, 30, 46, 0.2);\n  color: #F87171;\n  border: 1px solid rgba(192, 30, 46, 0.4);\n  animation: pulse-danger 1.5s infinite;\n}\n\n.status-badge.OFFLINE {\n  background-color: rgba(100, 116, 139, 0.2);\n  color: #94A3B8;\n  border: 1px solid rgba(100, 116, 139, 0.3);\n}\n\n@keyframes pulse-danger {\n  0% { box-shadow: 0 0 0 0 rgba(192, 30, 46, 0.4); }\n  70% { box-shadow: 0 0 0 6px rgba(192, 30, 46, 0); }\n  100% { box-shadow: 0 0 0 0 rgba(192, 30, 46, 0); }\n}\n\n.asset-sensors-list {\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n  margin: 12px 0;\n  flex-grow: 1;\n}\n\n.sensor-row {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 6px 10px;\n  background-color: var(--bg-input);\n  border-radius: var(--radius-sm);\n  font-size: 0.8rem;\n}\n\n.sensor-name-type {\n  color: var(--text-secondary);\n  display: flex;\n  align-items: center;\n  gap: 6px;\n}\n\n.sensor-val {\n  font-weight: 700;\n  color: var(--text-primary);\n}\n\n.sensor-val.warn { color: var(--bky-orange); }\n.sensor-val.crit { color: #F87171; font-weight: 800; }\n\n.asset-card-bottom {\n  border-top: 1px solid var(--border-color);\n  padding-top: 12px;\n  margin-top: 6px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n\n/* --- Tables & Lists --- */\n.table-container {\n  overflow-x: auto;\n}\n\n.sense-table {\n  width: 100%;\n  border-collapse: collapse;\n  text-align: left;\n  font-size: 0.85rem;\n}\n\n.sense-table th {\n  background-color: rgba(255, 255, 255, 0.02);\n  color: var(--text-muted);\n  font-weight: 600;\n  text-transform: uppercase;\n  font-size: 0.72rem;\n  letter-spacing: 0.5px;\n  padding: 12px 16px;\n  border-bottom: 1px solid var(--border-color);\n}\n\n.sense-table td {\n  padding: 14px 16px;\n  border-bottom: 1px solid var(--border-color);\n  color: var(--text-primary);\n  vertical-align: middle;\n}\n\n.sense-table tr:hover td {\n  background-color: var(--bg-card-hover);\n}\n\n/* --- Chart SVG Canvas --- */\n.chart-card {\n  padding: 20px;\n}\n\n.chart-svg {\n  width: 100%;\n  height: 260px;\n  overflow: visible;\n}\n\n/* --- Modals & Drawers --- */\n.modal-overlay {\n  position: fixed;\n  inset: 0;\n  background-color: rgba(0, 0, 0, 0.75);\n  backdrop-filter: blur(4px);\n  display: none;\n  align-items: center;\n  justify-content: center;\n  z-index: 100;\n  padding: 20px;\n}\n\n.modal-overlay.active {\n  display: flex;\n}\n\n.modal-box {\n  background-color: var(--bg-card);\n  border: 1px solid var(--border-color);\n  border-radius: var(--radius-lg);\n  width: 100%;\n  max-width: 640px;\n  max-height: 90vh;\n  display: flex;\n  flex-direction: column;\n  box-shadow: var(--shadow-lg);\n  overflow: hidden;\n  animation: modalScale 0.2s cubic-bezier(0.16, 1, 0.3, 1);\n}\n\n@keyframes modalScale {\n  from { opacity: 0; transform: scale(0.95); }\n  to { opacity: 1; transform: scale(1); }\n}\n\n.modal-header {\n  padding: 18px 24px;\n  border-bottom: 1px solid var(--border-color);\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n\n.modal-title {\n  font-size: 1.15rem;\n  font-weight: 700;\n}\n\n.modal-close-btn {\n  background: none;\n  border: none;\n  color: var(--text-muted);\n  cursor: pointer;\n  font-size: 1.25rem;\n  padding: 4px;\n}\n\n.modal-close-btn:hover {\n  color: var(--text-primary);\n}\n\n.modal-body {\n  padding: 24px;\n  overflow-y: auto;\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n}\n\n.modal-footer {\n  padding: 16px 24px;\n  border-top: 1px solid var(--border-color);\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n  gap: 12px;\n  background-color: rgba(0, 0, 0, 0.1);\n}\n\n/* --- Forms & Inputs --- */\n.form-group {\n  display: flex;\n  flex-direction: column;\n  gap: 6px;\n}\n\n.form-row {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 14px;\n}\n\n.form-label {\n  font-size: 0.8rem;\n  font-weight: 600;\n  color: var(--text-secondary);\n}\n\n.form-input, .form-select, .form-textarea {\n  background-color: var(--bg-input);\n  border: 1px solid var(--border-color);\n  border-radius: var(--radius-sm);\n  padding: 9px 12px;\n  color: var(--text-primary);\n  font-size: 0.88rem;\n  outline: none;\n  transition: border-color 0.15s ease;\n}\n\n.form-input:focus, .form-select:focus, .form-textarea:focus {\n  border-color: var(--border-focus);\n}\n\n.form-hint {\n  font-size: 0.72rem;\n  color: var(--text-muted);\n}\n\n/* --- Stateflow Workflow Visualizer --- */\n.stateflow-chain {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  overflow-x: auto;\n  padding: 20px 10px;\n}\n\n.state-node {\n  min-width: 150px;\n  background-color: var(--bg-input);\n  border: 2px solid var(--border-color);\n  border-radius: var(--radius-md);\n  padding: 12px 14px;\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n  position: relative;\n  transition: all 0.2s ease;\n}\n\n.state-node.active {\n  border-color: var(--bky-blue);\n  background-color: rgba(43, 56, 143, 0.15);\n  box-shadow: 0 0 12px rgba(43, 56, 143, 0.4);\n}\n\n.state-arrow {\n  color: var(--text-muted);\n  font-size: 1.2rem;\n  flex-shrink: 0;\n}\n\n/* --- Mobile View Simulator Overlay --- */\n.mobile-simulator-modal {\n  position: fixed;\n  inset: 0;\n  background-color: rgba(0, 0, 0, 0.85);\n  backdrop-filter: blur(8px);\n  display: none;\n  align-items: center;\n  justify-content: center;\n  z-index: 200;\n  padding: 20px;\n}\n\n.mobile-simulator-modal.active {\n  display: flex;\n}\n\n.phone-mockup {\n  width: 380px;\n  height: 740px;\n  background-color: #000;\n  border-radius: 44px;\n  border: 10px solid #1E293B;\n  box-shadow: 0 25px 60px -15px rgba(0, 0, 0, 0.8), 0 0 0 1px #334155;\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n  position: relative;\n}\n\n.phone-notch {\n  width: 140px;\n  height: 22px;\n  background-color: #1E293B;\n  border-bottom-left-radius: 12px;\n  border-bottom-right-radius: 12px;\n  margin: 0 auto;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 8px;\n  position: absolute;\n  top: 0;\n  left: 50%;\n  transform: translateX(-50%);\n  z-index: 50;\n}\n\n.notch-camera {\n  width: 8px;\n  height: 8px;\n  border-radius: 50%;\n  background-color: #0B0F19;\n}\n\n.phone-screen {\n  flex-grow: 1;\n  background-color: var(--bg-app);\n  overflow-y: auto;\n  display: flex;\n  flex-direction: column;\n  padding-top: 26px;\n}\n\n.mobile-nav-bar {\n  padding: 12px 16px;\n  background-color: var(--bg-sidebar);\n  border-bottom: 1px solid var(--border-color);\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n\n.mobile-bottom-bar {\n  background-color: var(--bg-sidebar);\n  border-top: 1px solid var(--border-color);\n  display: grid;\n  grid-template-columns: repeat(4, 1fr);\n  padding: 8px 4px;\n}\n\n.mobile-tab-btn {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 2px;\n  background: none;\n  border: none;\n  color: var(--text-muted);\n  font-size: 0.65rem;\n  font-weight: 600;\n  cursor: pointer;\n  padding: 4px;\n}\n\n.mobile-tab-btn.active {\n  color: var(--bky-blue);\n}\n\n[data-theme=\"dark\"] .mobile-tab-btn.active {\n  color: #60A5FA;\n}\n\n/* --- Code Snippet Box --- */\n.code-block {\n  background-color: #050811;\n  border: 1px solid var(--border-color);\n  border-radius: var(--radius-sm);\n  padding: 14px;\n  font-family: \"Fira Code\", monospace, Consolas, Courier;\n  font-size: 0.8rem;\n  color: #38BDF8;\n  overflow-x: auto;\n  position: relative;\n}\n\n.copy-btn {\n  position: absolute;\n  top: 8px;\n  right: 8px;\n  background-color: rgba(255, 255, 255, 0.1);\n  border: 1px solid rgba(255, 255, 255, 0.2);\n  color: #FFF;\n  font-size: 0.7rem;\n  padding: 3px 8px;\n  border-radius: 4px;\n  cursor: pointer;\n}\n\n.copy-btn:hover {\n  background-color: rgba(255, 255, 255, 0.2);\n}\n\n/* --- Tabs Strip --- */\n.tabs-strip {\n  display: flex;\n  align-items: center;\n  gap: 6px;\n  border-bottom: 1px solid var(--border-color);\n  padding: 0 20px;\n}\n\n.tab-btn {\n  padding: 12px 16px;\n  background: none;\n  border: none;\n  border-bottom: 2px solid transparent;\n  color: var(--text-secondary);\n  font-size: 0.88rem;\n  font-weight: 600;\n  cursor: pointer;\n  transition: all 0.15s ease;\n}\n\n.tab-btn:hover {\n  color: var(--text-primary);\n}\n\n.tab-btn.active {\n  color: #60A5FA;\n  border-bottom-color: #60A5FA;\n}\n\n[data-theme=\"light\"] .tab-btn.active {\n  color: var(--bky-blue);\n  border-bottom-color: var(--bky-blue);\n}\n\n/* --- Responsiveness --- */\n@media (max-width: 900px) {\n  .sidebar {\n    position: fixed;\n    top: 0;\n    bottom: 0;\n    left: 0;\n    transform: translateX(-100%);\n    box-shadow: var(--shadow-lg);\n  }\n  .sidebar.mobile-open {\n    transform: translateX(0);\n  }\n  .app-container {\n    flex-direction: column;\n  }\n}\n",
...
function serveStaticFile(req, res, pathname) {
  ...
  if (EMBEDDED_ASSETS[cleanPath]) {
    ...
    res.writeHead(200, { 'Content-Type': contentType });
    return res.end(EMBEDDED_ASSETS[cleanPath]);
  }
